...
watch(
  () => route.name,
  () => (isOpenNavigationMenu.value = false)
)
</script>

<template>
  <header
    class="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-shark-200 bg-white px-3 dark:border-shark-600 dark:bg-shark-700"
  >
    <AppBreadcrumbs />
